...
function YearCalendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 text-[#8D8D8D]",
        month: "space-y-4",
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-40 hover:opacity-100 text-[#8D8D8D]",
        ),
        ...
        day_selected:
          "bg-[#FF3E00] text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-[#FF3E00] focus:text-primary-foreground",
                ...
                <SelectContent position="popper">
                  <ScrollArea className="h-50">
                    {options.map((option, id: number) => (
                      <SelectItem
                        className="text-[#8D8D8D] text-muted-foreground opacity-70"
